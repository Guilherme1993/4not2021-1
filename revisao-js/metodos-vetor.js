...
// reduce(): reduz um vetor de vetores a um único valor.
//Parâmetros:
...
// 2º parâmetro do reduce(): valor inicial do acummulador
...
// Diferença entre o some() e includes()
// some() -> recebe uma função para testar a existência de um condição
